 ...
 *
 * @generated from message injective.downtimedetector.v1beta1.RecoveredSinceDowntimeOfLengthRequest
 */
export class RecoveredSinceDowntimeOfLengthRequest extends Message<RecoveredSinceDowntimeOfLengthRequest> {
  /**
   * @generated from field: injective.downtimedetector.v1beta1.Downtime downtime = 1;
   */
  ...
  static readonly typeName = "injective.downtimedetector.v1beta1.RecoveredSinceDowntimeOfLengthRequest";
...
/**
 * @generated from message injective.downtimedetector.v1beta1.RecoveredSinceDowntimeOfLengthResponse
 */
export class RecoveredSinceDowntimeOfLengthResponse extends Message<RecoveredSinceDowntimeOfLengthResponse> {
  /**
   * @generated from field: bool successfully_recovered = 1;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "injective.downtimedetector.v1beta1.RecoveredSinceDowntimeOfLengthResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "successfully_recovered", kind: "scalar", T: 8 /* ScalarType.BOOL */ },
  ]);
