...
// @generated from file vsc/evm/v1/genesis.proto (package vsc.evm.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck

import type { BinaryReadOptions, FieldList, JsonReadOptions, JsonValue, PartialMessage, PlainMessage } from "@bufbuild/protobuf";
import { Message, proto3 } from "@bufbuild/protobuf";
import { Params, State } from "cosmes/protobufs/sdk47/vsc/evm/v1/evm_pb.js";

/**
 * GenesisState defines the evm module's genesis state.
 *
 * @generated from message vsc.evm.v1.GenesisState
 */
export class GenesisState extends Message<GenesisState> {
  /**
   * accounts is an array containing the ethereum genesis accounts.
   *
   * @generated from field: repeated vsc.evm.v1.GenesisAccount accounts = 1;
   */
  ...
  static readonly typeName = "vsc.evm.v1.GenesisState";
 ...
 *
 * @generated from message vsc.evm.v1.GenesisAccount
 */
export class GenesisAccount extends Message<GenesisAccount> {
   ...
   *
   * @generated from field: repeated vsc.evm.v1.State storage = 3;
   */
  storage: State[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "vsc.evm.v1.GenesisAccount";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
