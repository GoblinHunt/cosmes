...
// @generated from file vsc/types/v1/dynamic_fee.proto (package vsc.types.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 *
 * @generated from message vsc.types.v1.ExtensionOptionDynamicFeeTx
 */
export class ExtensionOptionDynamicFeeTx extends Message<ExtensionOptionDynamicFeeTx> {
  ...
  static readonly typeName = "vsc.types.v1.ExtensionOptionDynamicFeeTx";
