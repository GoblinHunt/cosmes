...
// @generated from file vsc/types/v1/account.proto (package vsc.types.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck

import type { BinaryReadOptions, FieldList, JsonReadOptions, JsonValue, PartialMessage, PlainMessage } from "@bufbuild/protobuf";
import { Message, proto3 } from "@bufbuild/protobuf";
import { BaseAccount } from "cosmes/protobufs/sdk47/cosmos/auth/v1beta1/auth_pb.js";

/**
 * EthAccount implements the authtypes.AccountI interface and embeds an
 * authtypes.BaseAccount type. It is compatible with the auth AccountKeeper.
 *
 * @generated from message vsc.types.v1.EthAccount
 */
export class EthAccount extends Message<EthAccount> {
  ...
  static readonly typeName = "vsc.types.v1.EthAccount";
