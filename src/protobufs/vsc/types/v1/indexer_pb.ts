...
// @generated from file vsc/types/v1/indexer.proto (package vsc.types.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 *
 * @generated from message vsc.types.v1.TxResult
 */
export class TxResult extends Message<TxResult> {
  ...
  static readonly typeName = "vsc.types.v1.TxResult";
