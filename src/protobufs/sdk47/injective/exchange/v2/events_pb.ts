...
import { AccountRewards, CampaignRewardPool, DepositUpdate, DerivativePosition, DerivativeTradeLog, ExecutionType, FeeDiscountSchedule, GrantAuthorization, Level, SubaccountPosition, TradeLog, TradingRewardCampaignInfo } from "cosmes/protobufs/sdk47/injective/exchange/v2/exchange_pb.js";
import { BinaryOptionsMarket, DerivativeMarket, ExpiryFuturesMarketInfo, MarketFeeMultiplier, PerpetualMarketFunding, PerpetualMarketInfo, SpotMarket } from "cosmes/protobufs/sdk47/injective/exchange/v2/market_pb.js";
import { DerivativeLimitOrder, DerivativeMarketOrder, DerivativeOrder, SpotLimitOrder } from "cosmes/protobufs/sdk47/injective/exchange/v2/order_pb.js";
