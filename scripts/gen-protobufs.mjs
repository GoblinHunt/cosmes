...
console.log("Generating src/protobufs/index.ts file...");
{
  ...
  let contents =
    "/** This file is generated by gen-protobufs.mjs. Do not edit. */\n\n" +
    "import * as sdk47 from \"./sdk47/index.js\";\n" +
    "import * as sdk53 from \"./sdk53/index.js\";\n\n" +
    ...
    "  active = version === \"sdk53\" ? sdk53 : sdk47;\n" +
    "  applyActive();\n" +
    "};\n" +
  ...
  for (const entry of exportEntries) {
    contents += `export let ${entry.exportName}: typeof import(\"./sdk47/index.js\").${entry.exportName} = active.${entry.exportName};\n`;
  }

  contents += "\nconst applyActive = () => {\n";
  for (const entry of exportEntries) {
    contents += `  ${entry.exportName} = active.${entry.exportName};\n`;
  }
  contents += "};\napplyActive();\n";
