...
// @generated from file vsc/evm/v1/tx.proto (package vsc.evm.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck

import type { BinaryReadOptions, FieldList, JsonReadOptions, JsonValue, PartialMessage, PlainMessage } from "@bufbuild/protobuf";
import { Any, Message, proto3, protoInt64 } from "@bufbuild/protobuf";
import { AccessTuple, Log, Params } from "cosmes/protobufs/sdk47/vsc/evm/v1/evm_pb.js";

/**
 * MsgEthereumTx encapsulates an Ethereum transaction as an SDK message.
 *
 * @generated from message vsc.evm.v1.MsgEthereumTx
 */
export class MsgEthereumTx extends Message<MsgEthereumTx> {
  ...
  static readonly typeName = "vsc.evm.v1.MsgEthereumTx";
 ...
 *
 * @generated from message vsc.evm.v1.LegacyTx
 */
export class LegacyTx extends Message<LegacyTx> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "vsc.evm.v1.LegacyTx";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message vsc.evm.v1.AccessListTx
 */
export class AccessListTx extends Message<AccessListTx> {
   ...
   *
   * @generated from field: repeated vsc.evm.v1.AccessTuple accesses = 8;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "vsc.evm.v1.AccessListTx";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message vsc.evm.v1.DynamicFeeTx
 */
export class DynamicFeeTx extends Message<DynamicFeeTx> {
   ...
   * accesses is an array of access tuples
   *
   * @generated from field: repeated vsc.evm.v1.AccessTuple accesses = 9;
   */
  accesses: AccessTuple[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "vsc.evm.v1.DynamicFeeTx";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "chain_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "nonce", kind: "scalar", T: 4 /* ScalarType.UINT64 */ },
 ...
 *
 * @generated from message vsc.evm.v1.ExtensionOptionsEthereumTx
 */
export class ExtensionOptionsEthereumTx extends Message<ExtensionOptionsEthereumTx> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "vsc.evm.v1.ExtensionOptionsEthereumTx";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
 ...
 *
 * @generated from message vsc.evm.v1.MsgEthereumTxResponse
 */
export class MsgEthereumTxResponse extends Message<MsgEthereumTxResponse> {
   ...
   * logs.
   *
   * @generated from field: repeated vsc.evm.v1.Log logs = 2;
   */
  logs: Log[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "vsc.evm.v1.MsgEthereumTxResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message vsc.evm.v1.MsgUpdateParams
 */
export class MsgUpdateParams extends Message<MsgUpdateParams> {
   ...
   *
   * @generated from field: vsc.evm.v1.Params params = 2;
   */
  params?: Params;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "vsc.evm.v1.MsgUpdateParams";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message vsc.evm.v1.MsgUpdateParamsResponse
 */
export class MsgUpdateParamsResponse extends Message<MsgUpdateParamsResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "vsc.evm.v1.MsgUpdateParamsResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
