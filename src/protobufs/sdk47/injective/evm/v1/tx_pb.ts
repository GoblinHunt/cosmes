...
// @generated from file injective/evm/v1/tx.proto (package injective.evm.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck

import type { BinaryReadOptions, FieldList, JsonReadOptions, JsonValue, PartialMessage, PlainMessage } from "@bufbuild/protobuf";
import { Any, Message, proto3, protoInt64 } from "@bufbuild/protobuf";
import { AccessTuple } from "cosmes/protobufs/sdk47/injective/evm/v1/access_tuple_pb.js";
 ...
 *
 * @generated from message injective.evm.v1.MsgEthereumTx
 */
export class MsgEthereumTx extends Message<MsgEthereumTx> {
   ...
   *
   * @generated from field: string deprecated_hash = 3;
   */
  deprecatedHash = "";

  /**
   * @generated from field: string deprecated_from = 4 [deprecated = true];
   * @deprecated
   */
  deprecatedFrom = "";
  ...
  static readonly typeName = "injective.evm.v1.MsgEthereumTx";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "data", kind: "message", T: Any },
    { no: 2, name: "size", kind: "scalar", T: 1 /* ScalarType.DOUBLE */ },
    { no: 3, name: "deprecated_hash", kind: "scalar", T: 9 /* ScalarType.STRING */ },
 ...
 *
 * @generated from message injective.evm.v1.LegacyTx
 */
export class LegacyTx extends Message<LegacyTx> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "injective.evm.v1.LegacyTx";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message injective.evm.v1.AccessListTx
 */
export class AccessListTx extends Message<AccessListTx> {
   ...
   *
   * @generated from field: repeated injective.evm.v1.AccessTuple accesses = 8;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "injective.evm.v1.AccessListTx";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message injective.evm.v1.DynamicFeeTx
 */
export class DynamicFeeTx extends Message<DynamicFeeTx> {
   ...
   * accesses is an array of access tuples
   *
   * @generated from field: repeated injective.evm.v1.AccessTuple accesses = 9;
   */
  accesses: AccessTuple[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "injective.evm.v1.DynamicFeeTx";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "chain_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "nonce", kind: "scalar", T: 4 /* ScalarType.UINT64 */ },
 ...
 *
 * @generated from message injective.evm.v1.ExtensionOptionsEthereumTx
 */
export class ExtensionOptionsEthereumTx extends Message<ExtensionOptionsEthereumTx> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "injective.evm.v1.ExtensionOptionsEthereumTx";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
 ...
 *
 * @generated from message injective.evm.v1.MsgEthereumTxResponse
 */
export class MsgEthereumTxResponse extends Message<MsgEthereumTxResponse> {
   ...
   *
   * @generated from field: bytes block_hash = 6;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "injective.evm.v1.MsgEthereumTxResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message injective.evm.v1.MsgUpdateParams
 */
export class MsgUpdateParams extends Message<MsgUpdateParams> {
   ...
   *
   * @generated from field: injective.evm.v1.Params params = 2;
   */
  params?: Params;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "injective.evm.v1.MsgUpdateParams";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message injective.evm.v1.MsgUpdateParamsResponse
 */
export class MsgUpdateParamsResponse extends Message<MsgUpdateParamsResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "injective.evm.v1.MsgUpdateParamsResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
