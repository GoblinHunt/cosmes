...
// @generated from file vsc/oracle/v1/genesis.proto (package vsc.oracle.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 *
 * @generated from message vsc.oracle.v1.GenesisState
 */
export class GenesisState extends Message<GenesisState> {
  ...
  /**
   * @generated from field: repeated vsc.oracle.v1.FeederDelegation feeder_delegations = 2;
   */
  feederDelegations: FeederDelegation[] = [];

  /**
   * @generated from field: repeated vsc.oracle.v1.ExchangeRateTuple exchange_rates = 3;
   */
  exchangeRates: ExchangeRateTuple[] = [];

  /**
   * @generated from field: repeated vsc.oracle.v1.MissCounter miss_counters = 4;
   */
  missCounters: MissCounter[] = [];

  /**
   * @generated from field: repeated vsc.oracle.v1.AggregateExchangeRatePrevote aggregate_exchange_rate_prevotes = 5;
   */
  aggregateExchangeRatePrevotes: AggregateExchangeRatePrevote[] = [];

  /**
   * @generated from field: repeated vsc.oracle.v1.AggregateExchangeRateVote aggregate_exchange_rate_votes = 6;
   */
  ...
  static readonly typeName = "vsc.oracle.v1.GenesisState";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 7, name: "pairs", kind: "scalar", T: 9 /* ScalarType.STRING */, repeated: true },
  ]);
 ...
 *
 * @generated from message vsc.oracle.v1.FeederDelegation
 */
export class FeederDelegation extends Message<FeederDelegation> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "vsc.oracle.v1.FeederDelegation";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message vsc.oracle.v1.MissCounter
 */
export class MissCounter extends Message<MissCounter> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "vsc.oracle.v1.MissCounter";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
