...
// @generated from file injective/evm/v1/genesis.proto (package injective.evm.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
...
import { State } from "cosmes/protobufs/sdk53/injective/evm/v1/state_pb.js";

/**
 * GenesisState defines the evm module's genesis state.
 *
 * @generated from message injective.evm.v1.GenesisState
 */
export class GenesisState extends Message<GenesisState> {
  /**
   * accounts is an array containing the ethereum genesis accounts.
   *
   * @generated from field: repeated injective.evm.v1.GenesisAccount accounts = 1;
   */
  ...
  static readonly typeName = "injective.evm.v1.GenesisState";
 ...
 *
 * @generated from message injective.evm.v1.GenesisAccount
 */
export class GenesisAccount extends Message<GenesisAccount> {
   ...
   *
   * @generated from field: repeated injective.evm.v1.State storage = 3;
   */
  storage: State[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "injective.evm.v1.GenesisAccount";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
